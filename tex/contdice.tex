...
\textcolor{pink}{should we have a paragraph here about Dice and bitblast and sppl? }
...
if x < 0.4 then 
  ...
  \begin{subfigure}[t]{\textwidth}
    \begin{lstlisting}
let x = gaussian(0, 1) : float[<0.4,<0.5,<0.6; T] in
if x < (0.4 : float[<0.4,...; 0.4]) then
  ...
else if x < (0.5 : float[...; 0.5]) then
  ...
else if x < (0.6 : float[...; 0.6]) then
  ...
else
  ...
    \end{lstlisting}
...
\begin{subfigure}[t]{0.48\textwidth}
  \begin{lstlisting}
let x = discrete(0.655422, 0.0360407, 
0.0342844, 0.274253) in
if x < 1 then
  ...
else
  if x < 2 then
