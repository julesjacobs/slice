...
class BenchmarkRunner:
    ...
    def run_slice_on_file(self, slice_file):
...
class SliceCLI:
    ...
    def cmd_test(self, args):
        ...
        components = ['slice', 'dice', 'python', 'hyperfine']
        ...
        if 'python' in components:
            print("3. Testing Python environment...")
            result = self.run_command(
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 slice.py examples/coin.slice           # Run a program
