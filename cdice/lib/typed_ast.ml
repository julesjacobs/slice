(**
 * @file typed_ast.ml
 * @brief Defines the Typed Abstract Syntax Tree (TAST) for the ContDice language.
 *
 * This module specifies the structure of the AST after type checking.
 * It annotates the generic AST structure defined in `Ast.ml` with type
 * information from `TypeSystem.ml`. Each node in the TAST carries its
